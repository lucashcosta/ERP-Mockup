...
namespace WebAdmin
{
    public partial class Vehiculos : System.Web.UI.Page
    {
        ...
        {
            string strQuery = "SELECT [id] ,[nombre], [descripcion] FROM [dbo].[Vehiculos]";
        ...
        private void Delete(int id)
        {
            ...
            try
            {
                ...
                string sql_command = "DELETE FROM Vehiculos WHERE id=" + id;
        ...
        private void Add(string name, string desc)
        {
            ...
            connection.Open();
            string sql_insert = "INSERT INTO Vehiculos(nombre, descripcion) VALUES (@name, @desc)";
        ...
        private void Update(int idEdited, string newDesc) 
        {
            var connection = new SqlConnection(connectionString);
            connection.Open();
            string sql_update = "UPDATE Vehiculos SET descripcion = @nuevaDesc WHERE id = @idEditado"; // Update Desc only
        ...
        protected void addBtn_Click(object sender, EventArgs e)
        {
            ...
            Add(InputField.Text, DescField.Text);
            Response.Redirect("Vehiculos.aspx"); // Fix POST method when refreshing
        }
