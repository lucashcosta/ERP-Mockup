<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MedioContacto.aspx.cs" Inherits="WebAdmin.MedioContacto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Medios <small>Administracion de catalogos | Medios de referencia</small></h1>
                <ol class="breadcrumb">
                    <li><a href="Dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                    <li><a href="#"><i class="fa fa-book"></i> Catalogos</a></li>
                    <li class="active"><i class="fa fa-bullhorn"></i> Medios de referencia</li>
                </ol>
            </div>
        ...
        <div class="col-lg-4">
            <div class="panel panel-danger">
              <div class="panel-heading">
                  <h3 class="panel-title">Eliminar Medio</h3>
              ...
              <div class="panel-body">
                <div class="table-responsive">
                    <asp:DropDownList ID="dropDelete" AppendDataBoundItems="true" ClientIDMode="Static" runat="server" CssClass="table table-hover table-striped tablesorter">
                            <asp:ListItem Value="0">Selecciona un medio</asp:ListItem>
                    </asp:DropDownList>
            ...
            <div class="panel panel-warning">
              <div class="panel-heading">
                  <h3 class="panel-title">Propiedades de medio</h3>
                  <span class="pull-right clickable"><i class="fa fa-chevron-up"></i></span>
              </div>
              <div class="panel-body">
                  ...
                  <div id="updateFeilds" class="hidden">
                        ...
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-list-alt"></i></span>
                          <asp:TextBox ID="editDesc" runat="server" CssClass="form-control" placeholder="Descripcion (opcional)" ClientIDMode="Static">
                          </asp:Textbox>
                        </div>
                    </div>
                    <p></p>
                ...
                <div class="panel-body">
                    <div id="dvGrid" class="table-responsive">
                        <asp:GridView id="gridView" ClientIDMode="Static" 
                            ...
                            <Columns>
                                <asp:BoundField DataField="id_medio" HeaderText="ID" />                                                     
                                <asp:BoundField DataField="nombre_medio" HeaderText="Nombre"/>
                                <asp:BoundField DataField="descripcion_medio" HeaderText="Descripcion" />
                            </Columns>
                        </asp:GridView>
                    </div>
                    <!-- /.table-responsive -->
