...
namespace WebAdmin
{
    public partial class Descuentos : System.Web.UI.Page
    {
        ...
        {
            string strQuery = "SELECT [id] ,[nombre], [descripcion] FROM [dbo].[Promociones]";
            SqlCommand cmd = new SqlCommand(strQuery);
        ...
        private void Delete(int id)
        {
            ...
            try
            {
                ...
                string sql_command = "DELETE FROM Promociones WHERE id=" + id;
        ...
        private void Add(string name, string desc)
        {
            ...
            connection.Open();
            string sql_insert = "INSERT INTO Promociones(nombre, descripcion) VALUES (@name, @desc)";
        ...
        private void Update(int idEdited, string newDesc)
        {
            var connection = new SqlConnection(connectionString);
            connection.Open();
            string sql_update = "UPDATE Promociones SET descripcion = @nuevaDesc WHERE id = @idEditado"; // Update Desc only
        ...
        protected void addBtn_Click(object sender, EventArgs e)
        {
            ...
            if (InputField.Text == "" || DescField.Text == "")
                return;

            Add(InputField.Text, DescField.Text.Trim());
            Response.Redirect("Promociones.aspx"); // Fix POST method when refreshing
        }
