...
namespace WebAdmin
{
    public partial class Rutas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
       {
        ...
        {
            string strQuery = "SELECT [id] ,[nombre], [descripcion] FROM [dbo].[Rutas]";
        ...
        private void Delete(int id)
        {
            ...
            try
            {
                ...
                string sql_command = "DELETE FROM Rutas WHERE id=" + id;
        ...
        private void Add(string name, string desc)
        {
            ...
            connection.Open();
            string sql_insert = "INSERT INTO Rutas(nombre, descripcion) VALUES (@name, @desc)";
        ...
        private void Update(int idEdited, string newDesc)
        {
            var connection = new SqlConnection(connectionString);
            connection.Open();
            string sql_update = "UPDATE Rutas SET descripcion = @nuevaDesc WHERE id = @idEditado"; // Update Desc only
        ...
        protected void addBtn_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Rutas.aspx"); // Fix POST method when refreshing
        }
